...
export const feesAPI = {
  ...
  studentLedger: (studentId, params = {}) => api.get(`/finance/students/${studentId}/ledger`, { params }),
  ...
  updateFeeStructure: (id, data) => api.put(`/finance/fee-structures/${id}`, data),
  ...
  allocationTargets: (data) => api.post('/finance/allocations/targets', data),
  ...
  cancelReceipt: (receiptNo, data) => api.post(`/finance/receipts/${receiptNo}/cancel`, data),
  reissueReceipt: (receiptNo, data) => api.post(`/finance/receipts/${receiptNo}/reissue`, data),
  recordReceiptPrint: (receiptNo) => api.post(`/finance/receipts/${receiptNo}/print`),
