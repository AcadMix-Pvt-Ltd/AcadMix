...
const ROLES_DATA = [
  ...
  { name: 'QA / Automation Engineer', tags: ['software'] },
  // Advanced Tech & AI
  { name: 'Data Analyst', tags: ['data-ai', 'business'] },
  ...
  // Niche Tech
  { name: 'Blockchain Developer', tags: ['software', 'niche'] },
  { name: 'Game Developer', tags: ['software', 'gaming'] },
  { name: 'AR/VR Engineer', tags: ['software', 'hardware'] },
  // Product & Design
  { name: 'Product Manager (PM)', tags: ['product', 'business'] },
  ...
  { name: 'VLSI Design Engineer', tags: ['ece', 'hardware'] },
  { name: 'Electronics Engineer', tags: ['ece', 'hardware'] },
  { name: 'Electrical Engineer', tags: ['eee', 'core'] },
  { name: 'Control Systems Engineer', tags: ['eee', 'core', 'mech'] },
  { name: 'Power Electronics Engineer', tags: ['eee', 'core'] },
  { name: 'Telecom Engineer', tags: ['ece', 'networking'] },
  // Core Engineering - Mechanical & Civil
  { name: 'Mechanical Engineer', tags: ['mech', 'core'] },
  { name: 'Automotive Engineer', tags: ['mech', 'core'] },
  { name: 'HVAC Engineer', tags: ['mech', 'core'] },
  { name: 'Civil Engineer', tags: ['civil', 'core'] },
  { name: 'Structural Engineer', tags: ['civil', 'core'] },
  { name: 'Construction Manager', tags: ['civil', 'core', 'management'] },
  { name: 'Manufacturing Engineer', tags: ['mech', 'core'] },
  // Business & Management
...
const COMPANIES_DATA = [
  // Big Tech & MAANG
  { name: 'Google', tags: ['software', 'data-ai', 'infra', 'product', 'business', 'hardware', 'ece'] },
  { name: 'Amazon', tags: ['software', 'data-ai', 'infra', 'product', 'business', 'hardware'] },
  { name: 'Microsoft', tags: ['software', 'data-ai', 'infra', 'product', 'business', 'hardware'] },
  { name: 'Meta', tags: ['software', 'data-ai', 'infra', 'product', 'business', 'hardware'] },
  { name: 'Apple', tags: ['software', 'data-ai', 'infra', 'product', 'business', 'hardware', 'ece'] },
  ...
  { name: 'Infosys', tags: ['software', 'data-ai', 'infra', 'business', 'it'] },
  { name: 'Wipro', tags: ['software', 'data-ai', 'infra', 'business', 'it'] },
  { name: 'Cognizant', tags: ['software', 'data-ai', 'infra', 'business', 'it'] },
  { name: 'Accenture', tags: ['software', 'data-ai', 'infra', 'business', 'it'] },
  ...
  // Finance & Consulting
  { name: 'Goldman Sachs', tags: ['software', 'data-ai', 'infra', 'business', 'finance'] },
  { name: 'Morgan Stanley', tags: ['software', 'data-ai', 'infra', 'business', 'finance'] },
  { name: 'J.P. Morgan', tags: ['software', 'data-ai', 'infra', 'business', 'finance'] },
  { name: 'Deloitte', tags: ['software', 'data-ai', 'business', 'finance', 'it'] },
  { name: 'PwC', tags: ['software', 'data-ai', 'business', 'finance'] },
  { name: 'Barclays', tags: ['software', 'infra', 'finance'] },
  // Startups & Product
  { name: 'Flipkart', tags: ['software', 'data-ai', 'infra', 'product', 'business'] },
  { name: 'Zomato', tags: ['software', 'data-ai', 'product', 'business'] },
  { name: 'Swiggy', tags: ['software', 'data-ai', 'product', 'business'] },
  { name: 'Paytm', tags: ['software', 'data-ai', 'product', 'business', 'finance'] },
  { name: 'Cred', tags: ['software', 'data-ai', 'product', 'finance'] },
  ...
  { name: 'Jio', tags: ['software', 'infra', 'hardware', 'ece', 'eee', 'business'] },
  { name: 'MakeMyTrip', tags: ['software', 'data-ai', 'product'] },
  // Core ECE & Hardware
  { name: 'Intel', tags: ['hardware', 'ece', 'software'] },
  { name: 'Qualcomm', tags: ['hardware', 'ece', 'software'] },
  { name: 'Texas Instruments', tags: ['hardware', 'ece', 'eee'] },
  { name: 'AMD', tags: ['hardware', 'ece', 'software'] },
  { name: 'Broadcom', tags: ['hardware', 'ece'] },
  { name: 'NXP Semiconductors', tags: ['hardware', 'ece'] },
  { name: 'Bosch', tags: ['hardware', 'ece', 'eee', 'mech', 'core'] },
  // Core EEE & Power
  { name: 'Siemens', tags: ['eee', 'ece', 'mech', 'core', 'software'] },
  { name: 'ABB', tags: ['eee', 'mech', 'core'] },
  { name: 'Schneider Electric', tags: ['eee', 'core', 'ece'] },
  { name: 'General Electric (GE)', tags: ['eee', 'mech', 'core'] },
  { name: 'Adani Power', tags: ['eee', 'core'] },
  { name: 'Tata Power', tags: ['eee', 'core'] },
  // Core Mechanical & Automotive
  { name: 'Tata Motors', tags: ['mech', 'eee', 'core'] },
  { name: 'Mahindra & Mahindra', tags: ['mech', 'eee', 'core'] },
  { name: 'Maruti Suzuki', tags: ['mech', 'core'] },
  { name: 'Bajaj Auto', tags: ['mech', 'core'] },
  { name: 'Hero MotoCorp', tags: ['mech', 'core'] },
  { name: 'Larsen & Toubro (L&T)', tags: ['mech', 'civil', 'eee', 'core'] },
  { name: 'Honda', tags: ['mech', 'core'] },
  // Core Civil & Construction
  { name: 'Tata Projects', tags: ['civil', 'core'] },
  { name: 'Shapoorji Pallonji', tags: ['civil', 'core'] },
  { name: 'Adani Enterprises', tags: ['civil', 'core', 'mech'] },
  { name: 'GMR Group', tags: ['civil', 'core'] },
  { name: 'DLF', tags: ['civil', 'core'] },
  { name: 'Ultratech Cement', tags: ['civil', 'mech', 'core'] },
  { name: 'Other', tags: ['all'] }
];
